...
//   return (
//     <div className="relative h-auto w-[100vw] flex items-center justify-center overflow-hidden">
//       {/* <div className="absolute inset-0 bg-gradient-to-b from-[#A1C4FD] to-[#C2E9FB] transition-all duration-700" /> */}

//       {/* Slide Content */}
//       <div className="relative z-10 w-full flex flex-row items-center justify-between">
//         <div className="w-full">{slides[currentSlide].component}</div>
//       </div>
